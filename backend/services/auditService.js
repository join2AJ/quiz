...
const EVENTS = [
  ...
  'ADMIN_IMPORT_DATABASE', 'ADMIN_RESET_ATTEMPT', 'ADMIN_CHANGE_STATUS', 'ADMIN_EDIT_TEXT', 'QUESTION_REPORTED',
  'LOGIN_CONFLICT', 'SESSION_REPLACED', 'ADMIN_START_EXAM', 'ADMIN_DECLARE_RESULTS', 'ADMIN_FORCE_SUBMIT', 'SECTION_END',
  'EXAM_AUTO_SUBMIT', 'ROLES_SUBMITTED',
];
